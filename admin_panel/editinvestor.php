    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <p class="mb-4">Here below one form is given just fill out and click on the "submit" button for edit investor.</p>
                ...
                $qry="SELECT * FROM investors WHERE id=$investor_id";
                ...
                <div class="card shadow mb-4">
                    <div class="card-body">
                        <form class="investor" name="investorFrm" id="investorFrm" action="updateinvestor.php?investor_id=<?php echo $row['id']?>" enctype="multipart/form-data" method="post">
                            <input type="hidden"  name="txt_investorid" class="form-control" value="<?php echo $row['id']?>" required>
                            <div class="form-group">
                                <label>Investor Name:</label>
                                <input type="text" class="form-control" id="investorName" name="name" value="<?php echo $row['name']?>">
                            </div>

                           

                            <div class="form-group">
                                <label>Investor Pic:</label>
                                <input type="file" name="fileToUploadInvestor[]" class="form-control" id="investorImage" multiple accept="image/png,image/gif, image/jpeg"/>
   ...
   <?php require("./footer.php");?>
    ...
    $( document ).ready(function() {
        ...
        $(document).on('click','#submit',function(e){
              ...
              $("#investorFrm").find("div .sw-field__error").remove();
              $("#investorName").each(function() {
                  if($(this).val() == '') {
                    e.preventDefault();
        ...
        $(document).on('keyup', '#investorName', function () {
        ...
        // $(document).on('keyup', '#investorDescription', function () {
        ...
        //     }
        // });
        // $(document).on('click', '#investorImage', function () {
