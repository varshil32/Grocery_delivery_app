    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800">Add Catelogue</h1>
                <p class="mb-4">Here below one form is given just fill out and click on the "submit" button for add catelogue.</p>

                <!-- DataTales Example -->
                <div class="card shadow mb-4">
                    <div class="card-body">
                        <form class="plant" name="catelogueFrm" id="catelogueFrm" action="addcatelogueprocess.php" enctype="multipart/form-data" method="post">
                            <div class="form-group">
                                <label>Catelogue Name:</label>
                                <input type="text" class="form-control" id="catelogueName" name="name">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <p style="color:red">(Note*: only .pdf extension are allowed, and file size should be in beetween 100KB to 100MB)</p>
                            </div>
   ...
   <script type="text/javascript">
    $( document ).ready(function() {
        ...
        $(document).on('click','#submit',function(e){
            ...
            //   $("#catelogueName, #catelogueDescription, #catelogueImage").each(function() {
              $("#catelogueName,#catelogueImage").each(function() {   
                  if($(this).val() == '') {
                    e.preventDefault();
