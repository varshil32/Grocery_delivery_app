    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <p class="mb-4">Here below one form is given just fill out and click on the "submit" button for edit plant.</p>
                ...
                $qry="SELECT * FROM plants WHERE id=$plant_id";
                ...
                <div class="card shadow mb-4">
                    <div class="card-body">
                        <form class="plant" name="plantFrm" id="plantFrm" action="updateplant.php?plant_id=<?php echo $row['id']?>" enctype="multipart/form-data" method="post">
                            <input type="hidden"  name="txt_plantid" class="form-control" value="<?php echo $row['id']?>" required>
                            <div class="form-group">
                                <label>Plant Name:</label>
                                <input type="text" class="form-control" id="plantName" name="name" value="<?php echo $row['name']?>">
                            </div>

                            <div class="form-group">
                                <label>Plant Description:</label>
                                <textarea cols="10" rows="5" class="form-control" name="description" id="plantDescription"><?php echo $row['description']?></textarea>
                            </div>
   ...
   <?php require("./footer.php");?>
    ...
    $( document ).ready(function() {
        ...
        $(document).on('click','#submit',function(e){
              ...
              $("#plantName, #plantDescription").each(function() {
                  if($(this).val() == '') {
                    e.preventDefault();
