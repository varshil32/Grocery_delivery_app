    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <p class="mb-4">Here below one form is given just fill out and click on the "submit" button for add event.</p>

                <!-- DataTales Example -->
                <div class="card shadow mb-4">
                    <div class="card-body">
                        <form class="event" name="eventFrm" id="eventFrm" action="addeventprocess.php" enctype="multipart/form-data" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <textarea cols="10" rows="5" class="form-control" name="description" id="eventDescription"></textarea>
                            </div>
   ...
   <?php require("./footer.php");?>
    ...
    $( document ).ready(function() {
        ...
        $(document).on('click','#submit',function(e){
              ...
              $("#eventName, #eventDescription, #eventImage").each(function() {
                  if($(this).val() == '') {
                    e.preventDefault();
