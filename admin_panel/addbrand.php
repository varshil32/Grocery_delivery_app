    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <p class="mb-4">Here below one form is given just fill out and click on the "submit" button for add brand.</p>

                <!-- DataTales Example -->
                <div class="card shadow mb-4">
                    <div class="card-body">
                        <form class="plant" name="brandFrm" id="brandFrm" action="addbrandprocess.php" enctype="multipart/form-data" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <textarea cols="10" rows="5" class="form-control" name="description" id="brandDescription"></textarea>
                            </div>
   ...
   <script type="text/javascript">
    $( document ).ready(function() {
        ...
        $(document).on('click','#submit',function(e){
            ...
            //   $("#brandName, #brandDescription, #brandImage").each(function() {
              $("#brandImage").each(function() {   
                  if($(this).val() == '') {
                    e.preventDefault();
