    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800">Add Investor</h1>
                <p class="mb-4">Here below one form is given just fill out and click on the "submit" button for add investor.</p>

                <!-- DataTales Example -->
                <div class="card shadow mb-4">
                    <div class="card-body">
                        <form class="investor" name="investorFrm" id="investorFrm" action="addinvestorprocess.php" enctype="multipart/form-data" method="post">
                            ...
                            <!-- <div class="form-group">
                                <label>Investor Description:</label>
                                <textarea cols="10" rows="5" class="form-control" name="description" id="investorDescription"></textarea>
                            </div> -->

                            <div class="form-group">
                                <label>Investor Pic:</label>
                                <input type="file" name="fileToUploadInvestor[]" class="form-control" id="investorImage" multiple accept="image/png,image/gif, image/jpeg, image/jpg"/>
   ...
   <script type="text/javascript">
    $( document ).ready(function() {
        ...
        $(document).on('click','#submit',function(e){
              ...
              $("#investorName, #investorImage").each(function() {
                  if($(this).val() == '') {
                    e.preventDefault();
