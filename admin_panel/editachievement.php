    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800">Edit Achievement</h1>
                <p class="mb-4">Here below one form is given just fill out and click on the "submit" button for edit achievement.</p>
                ...
                $qry="SELECT * FROM achievements WHERE id=$achievement_id";
                ...
                <div class="card shadow mb-4">
                    <div class="card-body">
                        <form class="achievement" name="achievementFrm" id="achievementFrm" action="updateachievement.php?achievement_id=<?php echo $row['id']?>" enctype="multipart/form-data" method="post">
                            <input type="hidden"  name="txt_achievementid" class="form-control" value="<?php echo $row['id']?>" required>
                            <div class="form-group">
                                <label>Achievement Name:</label>
                                <input type="text" class="form-control" id="achievementName" name="name" value="<?php echo $row['name']?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="fileToUploadAchievement[]" class="form-control" id="achievementImage" multiple accept="image/png,image/gif, image/jpeg"/>
